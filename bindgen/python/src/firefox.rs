...
use decrypt_cookies_rs::{
    ...
    prelude::{FirefoxBuilder as FirefoxBuilderRs, FirefoxGetter as FirefoxGetterRs, *},
};
use pyo3::{
...
#[derive(Debug)]
#[derive(Default)]
pub struct FirefoxGetter(FirefoxGetterRs<Firefox>);
        ...
        future_into_py(py, async move {
            profile_path
                .map_or_else(
                    ...
                    |p| {
                        let with_profile_path = FirefoxBuilderRs::<Firefox>::with_profile_path(p);
...
impl Display for FirefoxGetter {
